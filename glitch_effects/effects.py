...
def animate_image(
    ...
    """
    Produce a gif with glitch effects. This function returns a list of frames, which you can write with write_frames_to_gif().
...
def glitch_image(
    ...
    """
    Produce a single image with glitch effects. This function returns an np.ndarray which you can write to file with skimage.io.imsave().
